...
class EarthTurret extends Turret {
    ...
    _renderable1: RenderablePathSet
    _renderable2: RenderablePathSet
    ...
    generateRenderables() {
        ...
        let grad1 = this.game._ctx.createRadialGradient(
            this.center.x, this.center.y, 0,
            this.center.x, this.center.y, 12
        )
        grad1.addColorStop(0, "#B6FF00")
        grad1.addColorStop(1, "#456000")
        this._renderable1.pushNew(path, grad1)
        let grad2 = this.game._ctx.createRadialGradient(
            this.center.x, this.center.y, 0,
            this.center.x, this.center.y, 12
        )
